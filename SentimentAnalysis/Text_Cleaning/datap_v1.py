...
# s = s[(s['Articles']!='[]')] # delelte the row with empty articles

# def istrip(art): return str(art).strip()
# s['Articles'] = s['Articles'].apply(istrip)

# s = s[(s['Articles']==)]
# print s

# print len(s)
# s = s.set_index('Dates',drop=False)
...
# s = s.set_index('Fixeddates',drop=False)
